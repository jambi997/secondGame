...
var fegyver = "res://weapons/sword5.tscn" 
var inventory

export (int) var rarity = 2
export (int) var id = 3
#var parentem 
var itself = "res://inventory/weaponinvs/swords/sword5item.tscn"
var text
...
func settext():
	text = "damage = 25-30\n makes you seem very dangerous "#\nwearer starts on the other side "
