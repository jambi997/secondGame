...
var fegyver = "res://weapons/sword13.tscn" 
var inventory

export (int) var rarity = 3
export (int) var id = 3
#var parentem 
var itself = "res://inventory/weaponinvs/swords/sword13item.tscn"
var text
...
func settext():
	text = "damage = 41-50\nattack speed: 0.6\ncharged attacks deals 200 bonus damage\nrecharges when an enemy or ally dies "
