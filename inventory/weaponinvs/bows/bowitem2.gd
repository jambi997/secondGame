...
var fegyver = "res://weapons/bow2.tscn" 
var inventory

export (int) var rarity = 3
export (int) var id = 3
#var parentem 
var itself = "res://inventory/weaponinvs/bows/bowitem2.tscn"
var text
...
func settext():
	text = "infests its target with a moss \nthat deals damage to it every 1 second,\nand and doubles its damage, \nstarting from one. \nthe stronger moss consumes \nthe weaker ones "
